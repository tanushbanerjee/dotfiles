...
```
yay -S awesome rofi picom i3lock-fancy xclip ttf-roboto materia-gtk-theme lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager -y
wget -qO- https://git.io/papirus-icon-theme-install | sh
```
...
```
git clone https://github.com/tanushbanerjee/awesome-config.git ~/.config/awesome
```
